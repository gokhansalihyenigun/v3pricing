...
<table class="table">
    <thead>
                ...
                <tbody>
                    <?php foreach ($products as $product) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="number" class="product-quantity" name="quantity_<?php echo $product['id']; ?>" data-price="<?php echo $product['unit_price']; ?>" min="0">
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
            ...
            <div class="form-group">
                <label for="total_price">Toplam Fiyat:</label>
